...
SuperagentHttpClient.prototype.execute = function (obj) {
  var responseAsStream = obj.stream;
  ...
  if(this.binaryRequest(accept)) {
    if(r.buffer && !responseAsStream) {
        r.buffer(true).parse(require('superagent/lib/node/parsers/image'));
    }
  ...
  if(obj.body) {
    if(_.isObject(obj.body) && typeof Buffer === 'function' && !Buffer.isBuffer(obj.body)) {
